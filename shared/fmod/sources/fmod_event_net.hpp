...
namespace FMOD
{
    ...
    FMOD_RESULT NetEventSystem_Init       (EventSystem *eventsystem, unsigned short port = FMOD_EVENT_NET_PORT);
    FMOD_RESULT NetEventSystem_Update     ();
    FMOD_RESULT NetEventSystem_Shutdown   ();
    FMOD_RESULT NetEventSystem_GetVersion (unsigned int *version);
}
