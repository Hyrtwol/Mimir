...
/*
// see https://learn.microsoft.com/en-us/windows/win32/api/winuser/nf-winuser-drawtext
...
// the style in core:sys/windows is consts but wanted to try to use the enum to scope it a bit
