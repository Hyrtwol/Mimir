...
verify_w95_colors :: proc(t: ^testing.T) {
	...
	c := cv.byte4{0x00, 0x00, 0x00, 0xFF}
	c.r = 0x1F
	expect_color(t, c, cv.byte4{0x1F, 0x00, 0x00, 0xFF})
	c.g = 0x2F
	expect_color(t, c, cv.byte4{0x1F, 0x2F, 0x00, 0xFF})
	c.b = 0x3F
	expect_color(t, c, cv.byte4{0x1F, 0x2F, 0x3F, 0xFF})
}
