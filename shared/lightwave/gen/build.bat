...
cl /c /Zi /I..\src /nologo /W3 /WX- /diagnostics:column /sdl /O2 /Oi /GL /D NDEBUG /D _CONSOLE /D _UNICODE /D UNICODE /Gm- /EHsc /MD /GS /Gy /fp:precise /Zc:wchar_t /Zc:forScope /Zc:inline /std:c++20 /permissive- /Fo"gen\x64\Release\\" /external:W3 /Gd /TP /FC /errorReport:queue gen.cpp
if %ERRORLEVEL% equ 0 (
...
:generate
if %ERRORLEVEL% equ 0 (
	%genexe% ..\tests\test_lightwave_generated.odin
)
